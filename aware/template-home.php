...
================================================== -->
    <div class="container clearfix">
	    ...
	    <ul class="biomenu">
		<li><a href="http://www.twitter.com/dingliu" target="_blank"><img src="http://liuding.com/wordpress/wp-content/uploads/2013/06/twitter.png" target="_blank"/></a></li>
		<li><a href="http://www.linkedin.com/in/dingliu" target="_blank"><img src="http://liuding.com/wordpress/wp-content/uploads/2013/06/linkedin.png" target="_blank"/></a></li>
		<li><a href="http://liuding.com/wordpress/bio" style="margin-right:64px;">// BIO</a></li>
	    </ul>
	</div>
        <div class="clear"></div>
    </div>
    <!-- Filter Portfolio Items
================================================== -->
<div class="container clearfix slideshow isotopecontainer">
...
<div class="clear"></div>
<?php endif; ?>
    <p class="copyright">&#169; 2015 liuding.com</p>
